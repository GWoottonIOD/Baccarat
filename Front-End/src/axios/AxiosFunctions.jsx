...
export const createQuery = (table, object) => {
    ...
    const axdebts = `${window.location.origin.slice(0,-5)}:8064/api/${table}/create`
...
export const updateQuery = (table, object) => {
    ...
    const axdebts = `${window.location.origin.slice(0,-5)}:8064/api/${table}/put/${object.id}`
...
export const deleteQuery = (table, filter) => {
    ...
    const axdebts = `${window.location.origin.slice(0,-5)}:8064/api/${table}/delete/${filter}`
